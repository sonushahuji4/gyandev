...
Pattern recognition comes from knowing the toolkit. Nearly every interval problem you'll see reduces to one of these five techniques.
...
| 3 | **Greedy selection** | Sort by end, greedily pick the earliest-finishing interval. For optimization — max kept, min removals, min resources. |
...
Every interval problem in this season maps to one of five core techniques. Use this table as your index.
